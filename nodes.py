...
class VAELoader:
    ...
    def load_taesd(name):
        ...
        if isinstance(enc, dict):
            ...
            logging.warning(
                f"VAE Approx encoder file {encoder} did not load correctly or is not a dictionary."
            )
        ...
        if isinstance(dec, dict):
            ...
            logging.warning(
                f"VAE Approx decoder file {decoder} did not load correctly or is not a dictionary."
            )
...
>>>>>>> a814f2e8ccf171c967ee2dc095dd02f2a93dccde
    RETURN_TYPES = ("CLIP",)
    FUNCTION = "load_clip"
...
class LoadImage:
    ...
    def load_image(self, image):
        ...
        for i in ImageSequence.Iterator(img):
            ...
            if i is None:  # Add check for None
                continue  # Skip this frame if transpose failed
